...
# safety systems tolerate a single bad level in what would
...
def problem_dampener(row: list) -> bool:
    """
    tries if the check row function returns true on any of its subrows 
